...
<script type="text/javascript">
     ...
     $(function () {
        ...
        function reload(str1,str2,sign)
        {
            //Imagebutton_Min Mushroom space(um)_ETCH
        ...
        function test(str)
        {
            window.open('EP_TRA_Level.aspx?' + str, 'Lv_Setting', config = 'height=400px,width=680px,left=200,top=0');
        }
    ...
    <form id="form1" runat="server">
        ...
        <div class="left">
            ...
            <asp:Panel ID="Panel_Query_Vername" runat="server">
                ...
                <legend class="legend" style="font-size:medium;"><strong>EPTRA_LV_Setting</strong></legend>  
